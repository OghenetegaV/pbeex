    ...
    <div>
        ...
        <section className='px-4 md:px-28 font-poppins font-medium text-darkgray'>
          ...
          <div className='my-12'>
            ...
            <div className='pt-4'>The Prof. O. A. Bamiro Engineering Expo &#40;PBEEX&#41; is a groundbreaking initiative that brings together engineering and technology students from tertiary institutions across Nigeria. This annual event is designed to foster innovation, research, and the development of ambitious engineering projects that address real-world challenges, inspire creativity, and drive technological advancements.</div>
          </div>
